# App and debugging roadmap — 2026-09-04 (historical)

> Historical design and acceptance record for the 5.3.2 work batch. It is not
> current operating guidance. For the active release and outstanding work, read
> the [product backlog](../product-backlog.md) and the repository `HANDOFF.md`.
...
The ranked completion list lived in the 2026-09-04
[product-backlog snapshot](product-backlog-2026-09-04.md). Current priorities
are in the [maintained backlog](../product-backlog.md).
